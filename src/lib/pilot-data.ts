...
export const DELTAS = {
  ...
  cpl: {
    msk: { wow: -46.67, vs5: -38.00, vs3: -45.40, avg5: 611, avg3: 694 },
    regions: { wow: 38.36, vs5: 42.64, vs3: 40.16, avg5: 83, avg3: 85 },
    pilot: { wow: -25.12, vs5: -10.05, vs3: -19.60, avg5: 189, avg3: 212 },
    control: { wow: -6.07, vs5: -25.92, vs3: -35.34, avg5: 102, avg3: 116 },
  },
} as const;

export const nf = new Intl.NumberFormat("ru-RU");
export const nfRub = new Intl.NumberFormat("ru-RU", { style: "currency", currency: "RUB", maximumFractionDigits: 0 });
